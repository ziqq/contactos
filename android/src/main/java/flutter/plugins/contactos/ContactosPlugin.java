...
public class ContactosPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
  ...
  /* public static void registerWith(Registrar registrar) {
    ContactosPlugin instance = new ContactosPlugin();
  ...
  /* private class ContactServiceDelegateOld extends BaseContactosDelegate {
