...
class ContactosIos extends ContactosPlatform {
  ContactosIos._({@visibleForTesting MethodChannelContactos? channel})
  ...
  static ContactosIos? _instance;

  /// Returns the [ContactosIos] singleton instance.
  /// Also registers this as the default platform implementation.
  // ignore: prefer_constructors_over_static_methods
  static ContactosIos get instance => _instance ??= ContactosIos._();

  /// Registers this class as the default instance of [ContactosIos].
  static void registerWith() {
    ContactosPlatform.instance = ContactosIos.instance;
  }
  ...
  ContactosPlatform delegateFor({
    required MethodChannelContactos channel,
      ...
      ContactosIos._(channel: channel);
