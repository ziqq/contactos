...
/// Android only: Localized labels language setting
/// Set androidLocalizedLabels=false if you always want english labels
/// whatever is the device language setting.
const kAndroidLocalizedLabels = false;
