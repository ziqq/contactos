...
class ContactosPluginAndroid extends ContactosPlatform {
  /// Creates a new plugin for iOS and macOS implementation instance.
  ContactosPluginAndroid._({MethodChannelContactos? channel})
    : _channel = channel ?? MethodChannelContactos.instance;

  /// Returns an instance using a specified [MethodChannelContactos].
  factory ContactosPluginAndroid._instanceFor({
    MethodChannelContactos? channel,
  }) => ContactosPluginAndroid._(channel: channel);

  /// Returns the default instance
  /// of [ContactosPluginAndroid].
  static ContactosPluginAndroid get instance => _instance;

  /// Returns an instance using the default [ContactosPluginAndroid].
  static final ContactosPluginAndroid _instance =
      ContactosPluginAndroid._instanceFor();
  ...
  static void registerWith() {
    ContactosPlatform.instance = ContactosPluginAndroid.instance;
  }
