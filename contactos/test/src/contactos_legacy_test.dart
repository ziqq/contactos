...
void main() => group('ContactosLegacy -', () {
  ...
  group('getContactsForPhone', () {
    ...
    test('returns contacts if phone number supplied', () async {
      final contacts = await Contactos.instance.getContactsForPhone(
        '1234567890',
      );
  ...
  test('should add contact', () async {
    await Contactos.instance.addContact(
      const Contact(
        givenName: 'givenName',
  ...
  test('should delete contact', () async {
    await Contactos.instance.deleteContact(
      const Contact(
        givenName: 'givenName',
        emails: [Contact$Field(label: 'label')],
        phones: [Contact$Field(label: 'label')],
  ...
  test('should update contact', () async {
    await Contactos.instance.updateContact(
      const Contact(
        givenName: 'givenName',
        emails: [Contact$Field(label: 'label')],
        phones: [Contact$Field(label: 'label')],
  ...
  test('should produce a valid merged contact', () {
    ...
    var contact2 = const Contact(
      familyName: 'familyName',
      phones: [Contact$Field(label: 'Mobile', value: '111-222-3344')],
      emails: [Contact$Field(label: 'Mobile', value: 'mobile@example.com')],
      postalAddresses: [
