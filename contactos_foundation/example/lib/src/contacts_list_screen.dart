...
class _ContactsListPageState extends State<ContactsListScreen> {
  ...
  Future<void> refreshContacts() async {
    // final contacts =
    // await ContactosPluginFoundation
    //   .instance
    //   .getContactsForPhone("8554964652");

    // Load without thumbnails initially.
    final contacts = await ContactosPluginFoundation.instance.getContacts(
    ...
    for (var contact in _contacts ?? contacts) {
      ContactosPluginFoundation.instance.getAvatar(contact).then((avatar) {
  ...
  Future<void> _openContactForm() async {
    try {
      var _ = await ContactosPluginFoundation.instance.openContactForm(
        iOSLocalizedLabels: iOSLocalizedLabels,
      );
      await refreshContacts();
    ...
    appBar: AppBar(
      ...
      actions: <Widget>[
        ...
        IconButton(
          ...
          onPressed: () {
            ContactosPluginFoundation.instance.deleteContact(widget._contact);
          },
        ),
        IconButton(
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () {
            ...
            ContactosPluginFoundation.instance.addContact(newContact);
            Navigator.of(context).pop();
          },
      ...
      actions: <Widget>[
        IconButton(
          ...
          onPressed: () async {
            ...
            await ContactosPluginFoundation.instance.updateContact(newContact);
